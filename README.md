...
| :--- | :--- | :--- | :--- |
| **🌐 Portfolio Website** | A minimalist, elegant space showcasing my code and canvas. | `HTML` `CSS` `JS` | [Live Site]() / [Repo](https://github.com/vartikadwivedi2005-code/Portfolio_web.git) |
